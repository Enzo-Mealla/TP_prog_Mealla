...
datos_juego = {"puntuacion":0,"vidas":CANTIDAD_VIDAS,"usuario":"","volumen_musica":100,"aciertos":0,"tiempo":10,"P_inicial": PUNTUACION_ACIERTO,"P_fallo": PUNTUACION_ERROR}
ventana_actual = "menu"
...
while corriendo:
    ...
    if ventana_actual == "menu":
        ...
        if bandera_musica == True:
            pygame.mixer.music.load("sonidos/final.mp3")
            pygame.mixer.music.play(-1)
            bandera_musica = False
